...
const plans = [
    ...
    },
    {
        ...
        price: '₹199',
        period: '/month',
        features: ['550 Products', 'Manual Product Import', 'Analytics', 'Email Support'],
        recommended: false,
    },
    {
        id: 'STANDARD',
        ...
        price: '₹499',
        period: '/month',
        features: ['4500 Products', 'Auto Product Import', 'Regular Customer Register', 'Analytics', 'Stock & Expiry Alerts', 'Call Support'],
        recommended: true,
    },
    {
        id: 'ADVANCED',
        ...
        price: '₹999',
        period: '/month',
        features: ['Unlimited Products', 'Auto Product Import', 'Regular Customer Register', 'Analytics', 'Stock & Expiry Alerts', '24x7 Call Support'],
        recommended: false,
    },
];
